...
@section('content')
    <div class="container mx-auto">
        <div class="flex">
            ...
            <div class="w-1/6">
                <div class="sticky pin-t pt-6">
                    <ul class="story-cta-links list-reset p-4 w-24">
                        <li>
                            <a href="" class="flex justify-start no-underline inline-block">
                                ...
                                <span class="text-sm pt-2 pl-1 text-grey-dark">{{ $post->claps }}</span>
                            </a>
                        </li>
                        <li><a href=""><svg class="svgIcon-use" width="29" height="29"><path d="M19.385 4h-9.77A2.623 2.623 0 0 0 7 6.615V23.01a1.022 1.022 0 0 0 1.595.847l5.905-4.004 5.905 4.004A1.022 1.022 0 0 0 22 23.011V6.62A2.625 2.625 0 0 0 19.385 4zM21 23l-5.91-3.955-.148-.107a.751.751 0 0 0-.884 0l-.147.107L8 23V6.615C8 5.725 8.725 5 9.615 5h9.77C20.275 5 21 5.725 21 6.615V23z" fill-rule="evenodd"></path></svg></a></li>
                        <li><a href=""><svg class="svgIcon-use" width="29" height="29"><path d="M22.053 7.54a4.474 4.474 0 0 0-3.31-1.455 4.526 4.526 0 0 0-4.526 4.524c0 .35.04.7.082 1.05a12.9 12.9 0 0 1-9.3-4.77c-.39.69-.61 1.46-.65 2.26.03 1.6.83 2.99 2.02 3.79-.72-.02-1.41-.22-2.02-.57-.01.02-.01.04 0 .08-.01 2.17 1.55 4 3.63 4.44-.39.08-.79.13-1.21.16-.28-.03-.57-.05-.81-.08.54 1.77 2.21 3.08 4.2 3.15a9.564 9.564 0 0 1-5.66 1.94c-.34-.03-.7-.06-1.05-.08 2 1.27 4.38 2.02 6.94 2.02 8.31 0 12.86-6.9 12.84-12.85.02-.24.01-.43 0-.65.89-.62 1.65-1.42 2.26-2.34-.82.38-1.69.62-2.59.72a4.37 4.37 0 0 0 1.94-2.51c-.84.53-1.81.9-2.83 1.13z"></path></svg></a></li>
                        <li><a href=""><svg class="svgIcon-use" width="29" height="29"><path d="M23.209 5H5.792A.792.792 0 0 0 5 5.791V23.21c0 .437.354.791.792.791h9.303v-7.125H12.72v-2.968h2.375v-2.375c0-2.455 1.553-3.662 3.741-3.662 1.049 0 1.95.078 2.213.112v2.565h-1.517c-1.192 0-1.469.567-1.469 1.397v1.963h2.969l-.594 2.968h-2.375L18.11 24h5.099a.791.791 0 0 0 .791-.791V5.79a.791.791 0 0 0-.791-.79"></path></svg></a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="w-3/4">
                <div class="story-header">
                    <h3 class="font-serif font-normal text-4xl mb-6">{{ $post->title }}</h3>
                </div>

                @include('post._story_author')

                <div class="story-body font-serif text-xl leading-normal">
                    {!! $post->body !!}
                </div>

                <div class="pb-4">
                    @foreach($post->tags as $tag)
                        <a href="" class="bg-grey-lighter text-xs rounded no-underline text-grey-darkest py-1 px-3 hover:text-black">#{{ $tag->name }}</a>
                    @endforeach
                </div>

                <hr class="border-t border-grey-light pb-4">
